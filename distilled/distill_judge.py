...
input_file_path = '../result/Llama-3.2-3B-Instruct-arena_distilled_dpo_0.05_lr_1e-6_epoch_1_et_lr_1e-5_epoch_3/arena.json'
output_file_path = '../data/arena_dpo_et_llama.json'
